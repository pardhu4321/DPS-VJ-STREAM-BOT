    ...
    if msg.media in [enums.MessageMediaType.VIDEO, enums.MessageMediaType.DOCUMENT]:
        ...
        rm=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton('✇ SHARE OUR BOT ✇', url="https://t.me/share/url?url=https://t.me/dps_file_to_link2_bot?start")
                ]
            ] 
        )
        msg_text = """<i><u>𝗬𝗼𝘂𝗿 𝗟𝗶𝗻𝗸 𝗚𝗲𝗻𝗲𝗿𝗮𝘁𝗲𝗱 !</u></i>\n\n<b>📂 Fɪʟᴇ ɴᴀᴍᴇ :</b> <i>{}</i>\n\n<b>📦 Fɪʟᴇ ꜱɪᴢᴇ :</b> <i>{}</i>\n\n<b>📥 Dᴏᴡɴʟᴏᴀᴅ :</b> <i>{}</i>\n\n<b> 🖥ᴡᴀᴛᴄʜ  :</b> <i>{}</i>\n\n<b>🚸 Nᴏᴛᴇ : <i><b>ᴘʟᴇᴀꜱᴇ ꜱʜᴀʀᴇ ᴏᴜʀ ʙᴏᴛ ɪꜰ ʏᴏᴜ ʟɪᴋᴇ 😇 </i>\n\n​ ᴛʜᴀɴᴋ ʏᴏᴜ ꜰᴏʀ ʏᴏᴜʀ ꜱᴜᴘᴘᴏʀᴛ & ʟᴏᴠᴇ ❤️ </b>"""
                                                                                                                                                                                                     #ʟɪɴᴋ ᴡᴏɴ'ᴛ ᴇxᴘɪʀᴇ ᴛɪʟʟ ɪ ᴅᴇʟᴇᴛᴇ                                                      
